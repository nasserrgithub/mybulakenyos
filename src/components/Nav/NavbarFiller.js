...
const NavbarFiller = ({onRouteChange, name}) => {
	return (
		    ...
		    <ul className="navbar-nav mr-auto">
		      <li className="nav-item dropdown">
		        ...
		        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
		          ...
		          <a
		          	onClick={() => onRouteChange('balagtasjobs')} 
		          	className="dropdown-item" style={{cursor: 'pointer'}}>Balagtas
		          </a>
		          <a
		          	onClick={() => onRouteChange('malolosjobs')} 
		          	className="dropdown-item" style={{cursor: 'pointer'}}>Malolos
		          </a>
		          <a
