	...
	return (
		<div style={{marginTop: '30px', marginLeft: '30px'}}>
			...
			<p style={{textAlign: 'left', marginBottom:'20px'}}>
				Email us on <strong>mybulakenyos@gmail.com</strong> with the following details:
			</p>
			<div className="reqs" style={{textAlign: 'left', marginLeft: '20px'}}>
				...
				<p style={{marginLeft: '40px'}}><strong>POSTING FEES:</strong> The service is free as of now. We will be asking for job posting fee as the website grows. </p>
