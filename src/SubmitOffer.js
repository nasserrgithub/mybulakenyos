	...
	return (
		<div style={{marginTop: '30px', marginLeft: '30px'}}>
			...
			<p style={{textAlign: 'left', marginBottom:'20px'}}>
				Email us on <strong style={{color: 'red'}}>mybulakenyos@gmail.com</strong> <em><strong style={{color: 'maroon'}}>using your myBulakenyos sign-in email</strong></em> with the following details:
			</p>
